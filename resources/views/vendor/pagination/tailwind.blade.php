            ...
            <span class="relative z-0 inline-flex gap-4 rtl:flex-row-reverse shadow-xs rounded-md">
                ...
                @else
                    <a href="{{ $paginator->previousPageUrl() }}" rel="prev"
                        class="relative inline-flex text-inherit items-center px-2 py-2 text-sm font-medium bg-white hover:bg-mine-400 transition cursor-default rounded-md leading-5"
                ...
                @foreach ($elements as $element)
                    ...
                    @if (is_array($element))
                        @foreach ($element as $page => $url)
                            ...
                            @else
                                <a href="{{ $url }}"
                                    class="relative inline-flex text-inherit items-center px-4 py-2 text-sm font-medium bg-white hover:bg-mine-400 transition cursor-default rounded-md leading-5"
